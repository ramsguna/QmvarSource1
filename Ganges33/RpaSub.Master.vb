Public Class RpaSub
    ...
    Protected Sub btnscheduler_Click(sender As Object, e As ImageClickEventArgs) Handles btnscheduler.Click
        Response.Redirect("rpa_scheduler.aspx")
    End Sub

    Protected Sub btnRpaLog_Click(sender As Object, e As ImageClickEventArgs) Handles btnRpaLog.Click
        Response.Redirect("rpa_logs.aspx")
    End Sub

    Protected Sub btnRpaTaskApp_Click(sender As Object, e As ImageClickEventArgs) Handles btnRpaTaskApp.Click
        Response.Redirect("Rpa_TaskApp.aspx")
    End Sub

    Protected Sub btnRpaOnOff_Click(sender As Object, e As ImageClickEventArgs) Handles btnRpaOnOff.Click
