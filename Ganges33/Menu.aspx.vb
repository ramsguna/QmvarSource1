...
Public Class Menu
    ...
    Protected Sub BtnInventry_Click(sender As Object, e As ImageClickEventArgs) Handles btnInventory.Click
        'Comment by Mohan on 2019.02.11 for Corporation Registration
        ' Response.Redirect("inv_Arrival.aspx")
        Response.Redirect("inv_corporation_regi.aspx")
    End Sub
    ...
    Protected Sub BtnSystem_Click(sender As Object, e As ImageClickEventArgs) Handles BtnSystem.Click
    ...
    Protected Sub BtnMVAR_Click(sender As Object, e As ImageClickEventArgs) Handles BtnMVAR.Click

    End Sub

    Protected Sub BtnPerson_Click(sender As Object, e As ImageClickEventArgs) Handles btnPerson.Click
