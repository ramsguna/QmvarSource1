<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site4.Master"  CodeBehind="Analysis_Cash_Tracking_qg.aspx.vb" Inherits="Ganges33.Analysis_Cash_Tracking_qg" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
     <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.7.0/jquery.min.js"></script>
    <link href="CSS/Common/Analysis-Cash-Tracking_qg.css" rel="stylesheet" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="div-entire-tbl" style="background-image: url('pagewall_2/wall_analysis-2.png')">
      <div class="div-analysis-cash-tracking">
            ...
            <table class="tbl-analysis-cash-tracking">
              ...
              <tr>
                  ...
                  <td class="td-lbl-review-report">
                      ...
                      <asp:Label ID="Label6" runat="server" Text="select  Day & Year" CssClass="lbl-font-common"></asp:Label>
                      <br />
                      <br />
                      <br />
                      <br />
                  ...
                  <td class="td-lbl-select-month-date">
                      ...
                      <asp:DropDownList ID="DropDownMonth" runat="server" CssClass="drpdown-warranty-month-day"  AutoPostBack="True">
                       ...
                       <asp:DropDownList ID="DropDownDay" runat="server" CssClass="drpdown-warranty-month-day2" >
                      </asp:DropDownList><asp:DropDownList ID="DropDownYear" runat="server" CssClass="drpdown-warranty-month-day2" >
                      </asp:DropDownList><br />
                      <br />
            ...
            <table class="tbl-analysis-cash-tracking-tbl" border="1">
                <tr>
                    <td class="td-blank2"></td>
                    <td class="td-payment-service-customers-invoice-collected-authorization-card"  style="background-color:#6699FF">
                        <asp:Label ID="lblPayment" runat="server" Text="Payment Method"  CssClass="lbl-font-common" ></asp:Label>
                    </td>
                    <td class="td-payment-service-customers-invoice-collected-authorization-card" style="background-color:#6699FF">
                ...
                <tr>
                    ...
                    <td class="td-payment-service-customers-invoice-collected-authorization-card">
                        <asp:CheckBox ID="ChkFullDiscount" runat="server"  CssClass="lbl-full-cash-discount-balance" Text="Full Discount" AutoPostBack="True" />
                    </td>
                    <td class="td-payment-service-customers-invoice-collected-authorization-card" style="background-color:#6699FF">
                        <asp:Label ID="lblDeposit" runat="server" Text="cash recived"  CssClass="lbl-full-cash-discount-balance" ></asp:Label>
                    </td>
                    <td class="td-blank1"></td>
                    <td class="td-blank1"></td>
                </tr>
                <tr>
                    ...
                    <td class="td-blank1" ></td>
                    <td class="td-payment-service-customers-invoice-collected-authorization-card"  style="background-color:#6699FF">
                        <asp:Label ID="lblDiscount" runat="server" Text="Discount" CssClass="lbl-full-cash-discount-balance" ></asp:Label>
                    </td>
                ...
                <tr>
                    ...
                    <td class="td-payment-service-customers-invoice-collected-authorization-card" style="background-color:#6699FF">
                        <asp:Label ID="lblChangeKoumoku" runat="server" Text="Balance"  CssClass="lbl-full-cash-discount-balance" ></asp:Label>
                    </td>
                    <td class="td-blank1"></td>
                    <td class="td-blank1"></td>
                </tr>
