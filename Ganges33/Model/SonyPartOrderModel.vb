...
Namespace Ganges33.model
    <Serializable>
    Public Class SonyPartOrderModel
        Public Sub SonyPartOrderModel()
            ...
            RPOCREMARK = String.Empty
            SRPCPONO = String.Empty
            NPC_SELLING_PRICE = String.Empty
        ...
        Public Property RPOCREMARK As String
        Public Property SRPCPONO As String
        Public Property NPC_SELLING_PRICE As String
