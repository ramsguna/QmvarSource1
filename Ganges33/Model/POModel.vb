...
Namespace Ganges33.model
    ...
    Public Class POModel
        Public Sub POModel()
            ...
            'Number = String.Empty
            'PODate = String.Empty
            'POBranchName = String.Empty

            'DSRBillingDate = String.Empty
            'DSRGoodsDeliveryDate = String.Empty
            'DSRBranchName = String.Empty

            'ReturnShipToBranch = String.Empty
            'ReturnShipToBranchCode = String.Empty
            'ReturnRequestDate = String.Empty

            'StockShipToBranch = String.Empty
            'StockShipToBranchCode = String.Empty
            'StockMonth = String.Empty

            'PaymentShipToBranch = String.Empty
            'PaymentToBranchCode = String.Empty
            'PaymentTargetDate = String.Empty

        End Sub
        'Public Property PODate As String
        'Public Property POBranchName As String

        'Public Property DSRBillingDate As String
        'Public Property DSRGoodsDeliveryDate As String
        'Public Property DSRBranchName As String

        'Public Property ReturnShipToBranch As String
        'Public Property ReturnShipToBranchCode As String
        'Public Property ReturnRequestDate As String

        'Public Property StockShipToBranch As String
        'Public Property StockShipToBranchCode As String
        'Public Property StockMonth As String

        'Public Property PaymentShipToBranch As String
        'Public Property PaymentToBranchCode As String
        'Public Property PaymentTargetDate As String
