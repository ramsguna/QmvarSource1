...
Namespace Ganges33.model
    <Serializable>
    Public Class G2sPaidModel
        Public Sub G2sPaidModel()
            CRTDT = String.Empty
            CRTCD = String.Empty
            UPDDT = String.Empty
            UPDCD = String.Empty
            ...
            PiadDate = String.Empty
            PaymentRequestDate = String.Empty
            Month = String.Empty
        ...
        Public Property PiadDate As String
        Public Property PaymentRequestDate As String
