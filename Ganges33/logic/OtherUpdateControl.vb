...
Public Class OtherUpdateControl


    Public Function AddModifyOtherUpdate(ByVal csvData()() As String, queryParams As OtherUpdateModel) As Boolean
        'Row 0 - Header 1
        '0 Samsung Ref No
        '1 Your Ref No
        '2 Model
        ...
        sqlStr = "SELECT TOP 1 SAMSUNG_REF_NO,YOUR_REF_NO FROM OTHER_UPDATE "
        ...
        Else 'The records is already exist, need to update DELFg=0
            ' isExist = 1
            sqlStr = "UPDATE OTHER_UPDATE SET DELFG=1  "
        ...
        If flagAll Then
            For i = 0 To csvData.Length - 1
                If i > 0 Then '0  Header
                    'If isExist = 1 Then
                    sqlStr = "Insert into OTHER_UPDATE ("
                    sqlStr = sqlStr & "CRTDT, "
                    sqlStr = sqlStr & "CRTCD, "
                    ' sqlStr = sqlStr & "UPDDT, "
                    sqlStr = sqlStr & "UPDCD, "
                    ...
                    dbConn.sqlCmd.Parameters.Add(CommonControl.GetNullableParameter("@TOTAL", queryParams.Total)) 'Don't Know
        ...
        Return flag
    End Function
    Public Function SelectOtherUpdate(ByVal queryParams As OtherUpdateModel) As DataTable
        Log4NetControl.ComInfoLogWrite(Log4NetControl.UserID)
        Dim dbConn As DBUtility = New DBUtility()
        Dim dt As DataTable = New DataTable()
        ...
        sqlStr = sqlStr & "SAMSUNG_REF_NO as 'Samsung Ref No',YOUR_REF_NO as 'Your Ref No',MODEL as 'Model',SERIAL as 'Serial',PRODUCT as 'Product',SERVICE as 'Service',DEFACT_CODE as 'Defect Code',CURRENCY as 'Currency',INVOICE as 'Invoice', LABOR as 'Labor',PARTS as 'Parts',FREIGHT as 'Freight',OTHER as 'Other',TAX as 'Tax' "
        sqlStr = sqlStr & "FROM "
        sqlStr = sqlStr & "OTHER_UPDATE "
        sqlStr = sqlStr & "WHERE "
